...
class Qwen3MLP(nn.Module):
    def __init__(self, config):
        ...
        self.gate_proj = Qlinear_FakeQuantizer(self.hidden_size, self.intermediate_size, bias=False)
        self.up_proj = Qlinear_FakeQuantizer(self.hidden_size, self.intermediate_size, bias=False)
...
class Qwen3Attention(nn.Module):
    ...
    def __init__(self, config: Qwen3Config, layer_idx: int):
        ...
        self.q_norm_output_qdq = ActivationQDQ(bits=act_bits)
        self.k_proj_output_qdq = ActivationQDQ(bits=8)
        self.k_norm_output_qdq = ActivationQDQ(bits=act_bits)
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        query_states = self.q_norm(
            self.q_proj_output_qdq(self.q_proj(hidden_states)).view(hidden_shape)
        ).transpose(1, 2)
        key_states = self.k_norm(
            self.k_proj_output_qdq(self.k_proj(hidden_states)).view(hidden_shape)
        ).transpose(1, 2)
