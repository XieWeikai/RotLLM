...
def matmul_hadU(X, transpose=False):        # 快速计算H的矩阵相乘
    ...
    input = X.clone().view(-1, n, 1) # [num, n, 1]
    output = input.clone()           # [num, n, 1]
    while input.shape[1] > K:        # n > K
        # [num, n, 1] -> [num, n//2, 2, 1]
...
def random_hadamard_matrix(size, device):       # 生成随机化的 Hadamard 正交矩阵
